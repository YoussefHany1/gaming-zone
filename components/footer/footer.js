...
export default function Footer() {
  return (
      <footer className="bg-(--primary) flex items-center flex-col">
          <div className="container flex justify-between items-center p-30">
              <div className="left flex items-center">
                  <Image src="/logo.png" alt="Logo" width={150} height={150} className="logo" />
                  <div className="text ml-5">
                      <p className="font-bold text-2xl w-2xl pr-10">The perfect place for the latest news, articles,and reviews of video games</p>
                      <ul className="flex items-center mt-5 gap-2">
                          ...
                          <li><a href="" className="youtube-icon" target="_blank"><lord-icon src="https://cdn.lordicon.com/lyjuidpq.json" trigger="morph" state="morph-circle" colors="primary:#fff,secondary:#fff" style={{ width: "50px", height: "50px" }}></lord-icon></a></li>
                          <li><a href="" className="x-icon" target="_blank"><lord-icon src="https://cdn.lordicon.com/yizwahhw.json" trigger="morph" state="morph-circle" colors="primary:#ffffff,secondary:#ffffff" style={{width:"50px",height:"50px"}}></lord-icon></a></li>
                      </ul>
