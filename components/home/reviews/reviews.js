...
export default function Reviews() {
  ...
  return (
    <>
      <section className="flex flex-col items-center bg-(--primary) p-10 rounded-4xl h-fit">
        <h2 className="p-5 px-10 bg-(--secondary) w-fit text-center rounded-2xl text-3xl font-bold">Reviews</h2>
