...
export default function HardwareScreen({ navigation }) {
  const [selectedSource, setSelectedSource] = useState(rssUrls.hardware[0]);
  ...
  if (error) {
    return <ErrorMessage message="Failed to load hardware news" />;
  }
  ...
  return (
    ...
    >
      <View style={styles.pickerContainer}>
        <Text style={styles.pickerLabel}>Select Hardware Source:</Text>
